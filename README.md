...
- 진행 및 제출 방법은 [미션 진행 및 제출 방법](https://github.com/LIN-KHU/linkhu-docs/blob/main/missionguide.md) 문서를 참고한다.
...
3. 시도 횟수를 입력받는다.
4. 시도 횟수번만큼 자동차를 전진시킨다

   4-1. [조건] 자동차 전진 조건은 난수를 발생시켜 4 이상인 경우다.
   4-2. 모든 자동차는 한 시도가 끝날 때마다 이름과 위치를 출력한다.
   
5. 모든 시도가 끝나면 위치 최댓값 찾는다.
6. 최대 위치값을 갖는 모든 자동차 이름을 출력한다.